...
namespace Modules\Outcomes\Providers;
...
class OutcomesServiceProvider extends ServiceProvider
{
    ...
    public function boot() {
        ...
        $moduleName = ApplicationModules::OUTCOMES_MODULE_NAME;
        config([
            $moduleName => File::getRequire(__DIR__.$ds.'..'.$ds.'config'.$ds.'outcomesConfig.php')
        ]);
