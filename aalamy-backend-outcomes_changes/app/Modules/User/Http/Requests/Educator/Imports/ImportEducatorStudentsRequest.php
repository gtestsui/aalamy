...
namespace Modules\User\Http\Requests\Educator\Imports;
...
class ImportEducatorStudentsRequest extends FormRequest
{
    ...
    public function authorize()
    {
        ...
        $this->setFileClass(
            FileServices::createFileClassByType($this->fileType,'educator')
        );
