...
namespace Modules\TeacherPermission\Http\Requests\Permission;
...
class GetPermissionsWithDefinedTeacherPermissionsRequest extends FormRequest
{
    /**
    ...
    public function authorizeAfterValidate()
    {
        ...
        $teacher = Teacher::findOrFail($this->route('teacher_id'));
