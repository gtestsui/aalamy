...
abstract class ClassStudentManagementFactory extends AbstractManagementFactory
{
    ...
    protected static $paths = [
        'educator' => EducatorClassStudent::class,
        'school' => SchoolClassStudent::class,
        'teacher' => TeacherClassStudent::class,
    ];
    ...
    public static function create(User $user,$teacherId=null):ManageClassStudentInterface
    {
