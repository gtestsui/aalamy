...
class CreateEducatorRosterStudentRequestsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('educator_roster_student_requests', function (Blueprint $table) {
            ...
            $table->enum('status',config('EducatorStudentRequest.panel.educator_roster_student_request_statuses'))->default(config('EducatorStudentRequest.panel.educator_roster_student_request_statuses.waiting'));
