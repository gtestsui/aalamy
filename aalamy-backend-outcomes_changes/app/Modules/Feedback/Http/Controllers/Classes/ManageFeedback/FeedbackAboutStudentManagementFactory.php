...
abstract class FeedbackAboutStudentManagementFactory extends AbstractManagementFactory
{
    ...
    protected static $paths = [
        'educator' => EducatorFeedbackAboutStudentClass::class,
        'school' => SchoolFeedbackAboutStudentClass::class,
        'teacher' => TeacherFeedbackAboutStudentClass::class,
    ];
    ...
    public static function create(User $user,$teacherId=null):ManageFeedbackAboutStudentInterface
    {
