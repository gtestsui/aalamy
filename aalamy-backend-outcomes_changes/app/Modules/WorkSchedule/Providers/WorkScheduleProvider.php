...
namespace Modules\WorkSchedule\Providers;
...
class WorkScheduleProvider extends ServiceProvider
{
    ...
    public function boot() {
        ...
        $moduleName = ApplicationModules::WORK_SCHEDULE_NAME;
        config([
            $moduleName => File::getRequire(__DIR__.$ds.'..'.$ds.'config'.$ds.'workScheduleConfig.php')
        ]);
