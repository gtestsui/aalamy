...
class ApproveOrRejectSchoolTeacherRequestNotification extends NotificationClass
{
    public $typeNum = 2;
    ...
    public function __construct($schoolRequest,$requestStatus)
    {
        ...
        $this->notificationType = parent::getNotificationType(
            configFromModule('panel.notification_types.approve_or_reject_school_teacher_request',ApplicationModules::NOTIFICATION_MODULE_NAME)
        );
