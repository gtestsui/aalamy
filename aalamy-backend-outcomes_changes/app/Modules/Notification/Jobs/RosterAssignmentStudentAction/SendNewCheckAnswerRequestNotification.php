...
class SendNewCheckAnswerRequestNotification implements ShouldQueue
{
    ...
    {
        $notification = new SendCheckAnswerRequestNotification($this->rosterAssignmentStudentAction);
