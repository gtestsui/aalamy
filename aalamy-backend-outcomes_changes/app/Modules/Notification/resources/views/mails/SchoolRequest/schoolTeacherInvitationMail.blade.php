...
@include('Notification::mails.Template.header',['title' => 'New invitation'])
                            ...
                            <tr>
                                <td style="padding:0 35px;">
                                    <h1 style="color:#1e1e2d; font-weight:500; margin:0;font-size:32px;font-family:'Rubik',sans-serif;">
                                        School joining invitation
                                    </h1>
                                    <p style="font-size:15px; color:#455056; margin:8px 0 0; line-height:24px;">
                                        you have an invitation to joining to the school : <strong>{{$schoolName}}</strong>.
                                        <br>
                                       , Email: <strong>{{$schoolEmail}}</strong>
