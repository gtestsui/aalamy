...
abstract class CalendarManagementFactory extends AbstractManagementFactory
{
    ...
    protected static $paths = [
        'educator' => EducatorCalendar::class,
        'school' => SchoolCalendar::class,
        'teacher' => TeacherCalendar::class,
        'student' => StudentCalendar::class,
        'parent' => ParentCalendar::class,
    ];
    ...
    public static function create(User $user,$date,$filterDateBy,$teacherId=null):BaseCalendarAbstract
    {
...
//        $accountType = strtolower($accountType);
        ...
        if(class_exists($classPath)){
            return new $classPath($accountObject,$date,$filterDateBy);
        }
        throw new ErrorMsgException('trying to declare invalid class type ');
    }
