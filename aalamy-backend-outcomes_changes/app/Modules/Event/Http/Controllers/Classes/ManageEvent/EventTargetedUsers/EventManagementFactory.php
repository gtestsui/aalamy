...
abstract class EventManagementFactory extends AbstractManagementFactory
{
...
//        'school' => SchoolEventOwner::class,
        'teacher' => TeacherEventTarget::class,
        'student' => StudentEventTarget::class,
        'parent' => ParentEventTarget::class,
    ];
    ...
    public static function create(User $user,$teacherId=null):BaseEventTargetAbstract
    {
