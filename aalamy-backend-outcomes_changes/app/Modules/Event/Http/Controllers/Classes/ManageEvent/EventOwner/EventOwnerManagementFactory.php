...
abstract class EventOwnerManagementFactory extends AbstractManagementFactory
{
    ...
    protected static $paths = [
        ...
        'teacher' => TeacherEventOwner::class,
    ];
    ...
    public static function create(User $user,$teacherId=null):ManageEventOwnerInterface
    {
