...
namespace Modules\RosterAssignment\Http\Requests\StudentPage;
...
class actionByPageForDefinedRosterStudentsRequest extends FormRequest
{
    /**
    ...
    public function authorizeAfterValidate()
    {
        ...
        $allowedActions = ['lock','hide'];
        if(!in_array($this->route('action'),$allowedActions))
            throw new ErrorMsgException('invalid action');
