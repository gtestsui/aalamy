...
class UpdateRosterAssignmentRequest extends FormRequest
{
    /**
    ...
    public function rules()
    {
        return [
            ...
            'start_date' => ['nullable','after_or_equal:'.date('Y-m-d'),'date_format:'.config('panel.standard_date_time_format')],
            'expiration_date' => ['nullable','date_format:'.config('panel.standard_date_time_format'),'after:start_date'],
