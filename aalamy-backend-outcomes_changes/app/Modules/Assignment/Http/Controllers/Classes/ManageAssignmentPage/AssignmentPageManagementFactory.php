...
abstract class AssignmentPageManagementFactory extends AbstractManagementFactory
{
    ...
    protected static $paths = [
        'educator' => EducatorAssignmentPage::class,
        'school' => SchoolAssignmentPage::class,
        'teacher' => TeacherAssignmentPage::class,
    ];
    ...
    public static function create(User $user,$teacherId=null):BaseAssignmentPageAbstract
    {
