...
abstract class AssignmentFolderManagementFactory extends AbstractManagementFactory
{
    ...
    protected static $paths = [
        'educator' => EducatorAssignmentFolder::class,
        'school' => SchoolAssignmentFolder::class,
        'teacher' => TeacherAssignmentFolder::class,
//        'student' => StudentAssignment::class,
    ...
    public static function create(User $user,$teacherId=null):BaseAssignmentFolderClassAbstract
    {
