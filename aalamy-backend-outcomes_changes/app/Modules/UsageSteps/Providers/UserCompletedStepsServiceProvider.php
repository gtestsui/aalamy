...
namespace Modules\UsageSteps\Providers;
...
class UserCompletedStepsServiceProvider extends ServiceProvider
{
    ...
    public function boot() {
        ...
        $moduleName = ApplicationModules::USAGE_STEPS_MODULE_NAME;
        config([
            $moduleName => File::getRequire(__DIR__ . $ds.'..'.$ds.'config'.$ds.'usageStepsConfig.php')
        ]);
