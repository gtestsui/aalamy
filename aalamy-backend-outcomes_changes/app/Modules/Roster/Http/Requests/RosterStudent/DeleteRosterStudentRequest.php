...
class DeleteRosterStudentRequest extends FormRequest
{
    /**
    ...
    {
        return [
            'roster_student_ids' => 'required|array',
//            'roster_student_ids.*' => 'required|exists:roster_students,id',
            'roster_student_ids.*' => 'required|exists:'.(new RosterStudent())->getTable().',id',
