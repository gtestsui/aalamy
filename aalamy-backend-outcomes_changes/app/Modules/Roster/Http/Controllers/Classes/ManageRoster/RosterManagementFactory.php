...
abstract class RosterManagementFactory extends AbstractManagementFactory
{
    ...
    protected static $paths = [
        'educator' => EducatorRosterClass::class,
        'school' => SchoolRosterClass::class,
        'teacher' => TeacherRosterClass::class,
    ...
    public static function create(User $user,$teacherId=null):ManageRosterInterface
    {
