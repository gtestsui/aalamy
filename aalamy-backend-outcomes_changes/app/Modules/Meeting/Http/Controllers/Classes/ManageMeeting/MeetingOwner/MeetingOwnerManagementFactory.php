...
abstract class MeetingOwnerManagementFactory extends AbstractManagementFactory
{
    ...
    protected static $paths = [
        'educator' => EducatorMeetingOwnerClass::class,
        'school' => SchoolMeetingOwnerClass::class,
        'teacher' => TeacherMeetingOwnerClass::class,
//        'parent' => ParentRosterClass::class,
//        'student' => StudentRosterClass::class,
    ];
    ...
    public static function create(User $user,$teacherId=null):BaseManageMeetingByOwnerAbstract
    {
