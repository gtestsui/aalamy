...
abstract class MeetingTargetManagementFactory extends AbstractManagementFactory
{
...
//        'educator' => EducatorEventOwner::class,
//        'school' => SchoolEventOwner::class,
        'teacher' => TeacherMeetingTarget::class,
        'student' => StudentMeetingTarget::class,
        'parent' => ParentMeetingTarget::class,
    ];
    ...
    public static function create(User $user,$teacherId=null):BaseMeetingTargetAbstract
    {
...
//        $accountType = strtolower($accountType);
    ...
    public static function createByAccountTypendObject($accountType,$accountObject):BaseMeetingTargetAbstract
    {
        //we made this to check on teacher type
//        list($accountType,$accountObject) = UserServices::getAccountTypeAndObject($user,$teacherId);
//        $accountType = strtolower($accountType);
