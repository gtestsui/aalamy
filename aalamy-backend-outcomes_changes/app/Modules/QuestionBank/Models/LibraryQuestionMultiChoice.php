...
use Modules\QuestionBank\Traits\ModelRelations\LibraryQuestion\MultiChoiceRelations;

class LibraryQuestionMultiChoice extends Model
{
    ...
    protected $table = 'library_question_multi_choices';
