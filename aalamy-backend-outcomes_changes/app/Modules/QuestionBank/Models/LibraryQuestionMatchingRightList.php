...
use Modules\QuestionBank\Traits\ModelRelations\LibraryQuestion\MatchingRightListRelations;

class LibraryQuestionMatchingRightList extends Model
{
    ...
    protected $table = 'library_question_matching_right_lists';
