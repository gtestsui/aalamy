...
use Modules\QuestionBank\Traits\ModelRelations\QuestionBank\OrderingRelations;

class QuestionBankOrdering extends Model
{
    use DefaultGlobalScopes;
    use HasFactory;
    use SoftDelete;
    use OrderingRelations;

    protected $table = 'question_bank_ordering';
