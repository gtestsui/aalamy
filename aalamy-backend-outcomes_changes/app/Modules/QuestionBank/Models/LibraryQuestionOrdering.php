...
use Modules\QuestionBank\Traits\ModelRelations\LibraryQuestion\OrderingRelations;

class LibraryQuestionOrdering extends Model
{
    ...
    protected $table = 'library_question_ordering';
