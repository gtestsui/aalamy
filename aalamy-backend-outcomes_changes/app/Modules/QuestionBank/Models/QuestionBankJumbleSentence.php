...
use Modules\QuestionBank\Traits\ModelRelations\QuestionBank\JumbleSentenceRelations;
use Modules\QuestionBank\Traits\ModelRelations\QuestionBank\TrueFalseRelations;

class QuestionBankJumbleSentence extends Model
{
    use DefaultGlobalScopes;
    use HasFactory;
    use SoftDelete;
    use JumbleSentenceRelations;

    protected $table = 'question_bank_jumble_sentences';

    public static function customizedBooted(){//stop the global scope DefaultOrderByScope
    ...
    protected $relationsSoftDelete = [
        ...
        'QuizQuestionJumbleSentenceAnswers',
