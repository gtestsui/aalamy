...
use Modules\QuestionBank\Traits\ModelRelations\QuestionBank\MatchingLeftListRelations;

class QuestionBankMatchingLeftList extends Model
{
    ...
    protected $table = 'question_bank_matching_left_lists';
