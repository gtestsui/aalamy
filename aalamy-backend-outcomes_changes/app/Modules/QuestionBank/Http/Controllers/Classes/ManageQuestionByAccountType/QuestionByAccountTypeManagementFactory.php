...
abstract class QuestionByAccountTypeManagementFactory /*extends AbstractManagementFactory*/
{
    ...
    protected static $paths = [
        'educator' => EducatorQuestionManagement::class,
        'school' => SchoolQuestionManagement::class,
    ...
    public static function create(User $user/*,$teacherId*/):BaseManageQuestionByAccountTypeAbstract
    {
