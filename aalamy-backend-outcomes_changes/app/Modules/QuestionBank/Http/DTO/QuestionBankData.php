...
final class QuestionBankData extends ObjectData
{
    public ?int      $id=null;
...
////    public ?Carbon   $created_at;
    ...
    public static function fromRequest(Request $request,QuestionBank $questionBank=null): self
    {
        $user = $request->user();
        ...
        //the question_type couldn't be updated
        $questionType = isset($questionBank)
