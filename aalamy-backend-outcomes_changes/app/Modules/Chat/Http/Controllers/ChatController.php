...
class ChatController extends Controller
{
    ...
    public function getMyChatsPaginate(GetMyChatsRequest $request){
        ...
        //we do this to load all schools for the parent event there is no chat found before
        if ($user->account_type == 'parent'){
            ...
            $schools = School::whereIn('id',$schoolIds)
                ...
                ->with('User.School')//because the fronted build his component to work like this nested functions and there is no time to let him change it now
                ->get();
        }
