...
abstract class ChatManagementFactory  extends AbstractManagementFactory
{
    ...
    protected static $paths = [
        'parent' => ParentChat::class,
        'school' => SchoolChat::class,
    ];
    ...
    public static function create(User $user,$teacherId=null):BaseChatClassAbstract
    {
