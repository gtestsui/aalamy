...
use Modules\ClassModule\Http\Controllers\Classes\ManageClassStudent\SchoolClassStudent;
...
class StudentAchievementSchool extends BaseStudentAchievement
{
    ...
    public function store(StudentAchievementData $studentAchievementData){
        ...
        $classStudent = new SchoolClassStudent($this->school);
    ...
    public function getMyStudentAchievementWaitingToPublish(){
        $strudentEducatorClass = new StudentSchoolClass($this->school);
