...
class ManualNotificationModuleClass extends BasePlanConstraintsClass
{
    /**
    ...
    public static function createByOwner(User $user){
        ...
        $static->module = Module::where(
                'identify',getModuleIdentify('manual_notification')
            )
    ...
    /**
     * other here are teachers (when teacher trying to send manual notification in his school if he has permission)
