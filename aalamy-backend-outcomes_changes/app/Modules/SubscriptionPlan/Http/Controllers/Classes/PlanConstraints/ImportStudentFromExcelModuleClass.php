...
class ImportStudentFromExcelModuleClass extends BasePlanConstraintsClass
{
    /**
    ...
    public static function createByOwner(User $user){
        ...
        $static->module = Module::where(
                'identify',getModuleIdentify('import_students_from_excel')
            )
    ...
    /**
     * other here are teachers (when teacher trying to import in his school if he has permission)
