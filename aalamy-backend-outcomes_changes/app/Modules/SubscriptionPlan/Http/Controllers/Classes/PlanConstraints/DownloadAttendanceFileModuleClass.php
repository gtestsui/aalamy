...
class DownloadAttendanceFileModuleClass extends BasePlanConstraintsClass
{
    /**
    ...
    public static function createByOwner(User $user){
        ...
        $static->module = Module::where(
                'identify',getModuleIdentify('download_attendance_file')
            )
    ...
    /**
     * other here are teachers (when teacher trying to download attendance file in his school if he has permission)
