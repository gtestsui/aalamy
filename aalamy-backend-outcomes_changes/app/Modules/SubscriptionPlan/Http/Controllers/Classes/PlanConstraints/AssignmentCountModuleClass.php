...
class AssignmentCountModuleClass extends BasePlanConstraintsClass
{
...
//    }
    ...
    public static function createByOwner(User $user)
    {
        ...
        $static->module = Module::where(
                'identify',getModuleIdentify('assignments_count')
            )
    ...
    public function checkWithCustomizedErrorForTeacher($msg=null){
        ...
        $msg = $msg ?? transMsg('max_count_of_school_assignments',ApplicationModules::SUBSCRIPTION_PLAN_MODULE_NAME);
