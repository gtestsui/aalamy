...
abstract class MyOwnTopicByAccountTypeManagementFactory /*extends AbstractManagementFactory*/
{
    ...
    protected static $paths = [
        'educator' => EducatorMyOwnTopicManagement::class,
        'school' => SchoolMyOwnTopicManagement::class,
//        'teacher' => TeacherQuestionManagement::class,
    ...
    public static function create(User $user/*,$teacherId*/):BaseManageMyOwnTopicByAccountTypeAbstract
    {
...
//        $accountType = strtolower($accountType);
    ...
    public static function createByAccountTypeAndObject($accountType,$accountObject/*User $user*//*,$teacherId*/):BaseManageMyOwnTopicByAccountTypeAbstract
    {
