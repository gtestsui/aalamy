...
abstract class MyAllowedLearningResourceByAccountTypeManagementFactory /*extends AbstractManagementFactory*/
{
    ...
    protected static $paths = [
        'educator' => EducatorMyAllowedLearningResourceManagement::class,
        'school' => SchoolMyAllowedLearningResourceManagement::class,
        'student' => StudentMyAllowedLearningResourceManagement::class,
//        'teacher' => TeacherQuestionManagement::class,
    ...
    public static function create(User $user/*,$teacherId*/):BaseManageMyAllowedLearningResourceByAccountTypeAbstract
    {
...
//        $accountType = strtolower($accountType);
    ...
    public static function createByAccountTypeAndObject($accountType,$accountObject/*User $user,$teacherId*/):BaseManageMyAllowedLearningResourceByAccountTypeAbstract
    {
